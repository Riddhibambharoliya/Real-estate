      ...
      <div className="flex justify-center items-center md:py-10 py-2 bg-[#eeeeee]">
        <div className="relative w-full lg:w-10/12 md:w-10/12 flex justify-center items-center">
          ...
          <div
            ...
            style={{
              backgroundImage: `url('https://websitedemos.net/real-estate-company-04/wp-content/uploads/sites/1484/2023/07/about-bg.jpg')`,
            }}
          >
            ...
            <div className="absolute inset-0 z-20 h-full flex flex-col items-center justify-start text-center text-white px-4 md:px-0">
              <div className="flex justify-start items-center w-full">
                ...
                {isMenuOpen && (
                  <div className="absolute top-16 flex justify-start items-start left-0 w-full bg-teal-600 text-white md:hidden z-50">
              ...
              <div className="h-full flex justify-center items-center flex-col">
                <h4 className="text-sm md:text-lg lg:text-xl mt-4 font-semibold">ABOUT</h4>
                ...
                <form
                  ...
                  className="transform flex justify-center items-center w-full z-10 mt-5 px-4 lg:px-0"
                >
