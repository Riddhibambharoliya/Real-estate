            ...
            >
              ...
              <div className="absolute inset-0 z-20 h-full flex flex-col items-center justify-start text-center text-white px-4 md:px-0">
                ...
                <div className="h-full flex justify-center items-center flex-col">
                  <h4 className="text-sm md:text-lg lg:text-xl mt-4 font-semibold">Contact Us</h4>
                  ...
                  <form
                    ...
                    className="transform flex justify-center items-center w-full z-10 mt-5 px-4 lg:px-0 p-3"
                  >
